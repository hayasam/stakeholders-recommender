...
public class EffortCalculatorSchema implements Serializable {
    @ApiModelProperty(notes = "List of hours for effort 1.", example = "[1,1,1,1]", required = true)
    public List<Integer> one;
    @ApiModelProperty(notes = "List of hours effort 2.", example = "[2,2,2,2]", required = true)
    public List<Integer> two;
    @ApiModelProperty(notes = "List of hours effort 3.", example = "[3,3,3,3]", required = true)
    public List<Integer> three;
    @ApiModelProperty(notes = "List of hours effort 4.", example = "[4,4,4,4]", required = true)
    public List<Integer> four;
    @ApiModelProperty(notes = "List of hours effort 5.", example = "[5,5,5,5]", required = true)
