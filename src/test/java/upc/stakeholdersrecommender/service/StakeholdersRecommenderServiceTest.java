...
public class StakeholdersRecommenderServiceTest {
    ...
    public void testRecommendLeftovers() throws Exception {
        ...
        List<RecommendReturnSchema> result = instance.recommend(req, k, true, "UPC",2);
        String res = mapper.writeValueAsString(result);
        String s="[{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"1\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.5},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"78\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.34778162711913707},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"2\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.34660395655762755},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"15\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3231493865180058},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"254\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.31169132423165874},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"22\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.3023147143674163},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"142\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.2761480653018595},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"44\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.21861062739745343},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"260\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.21351428586853238},{\"requirement\":{\"id\":\"1\"},\"person\":{\"username\":\"257\"},\"availabilityScore\":1.0,\"appropiatenessScore\":0.2051140215602294}]\n";
        Double dist=(double) distance(s,res);
        Double percentage =dist/res.length();
        System.out.println(res);
        assertTrue(percentage<0.1);
